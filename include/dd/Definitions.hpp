...
namespace dd {
    ...
    // TODO understand how many quantum registers to put in a circuit, depending on the dimensions

    using QuantumRegister = std::int_fast8_t;

    static_assert(std::is_signed_v<QuantumRegister>, "Type QuantumRegister must be signed.");
